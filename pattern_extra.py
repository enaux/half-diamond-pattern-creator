...
It then allows the user to create as many patterns as they wish, and to choose the size.
...
# Then allow user to choose to print another pattern or to exit.
...
# while-loop will print patterns for the user as long as they choose to continue.
while not done:
